...
//
//    public static char[] apicales = { 't', 'l', 'j', '&', 's', 'n', 'd' };
//
//    public static char[] bilabiales = { 'p', 'v', 'm', 'b' };
//
//    public static char[] velaires = { 'k', 'g', 'N' };
//
//    public static char[] uvulaires = { 'q', 'r' };
//
//
//    public static boolean consonneApicale(char car) {
//        if (Arrays.binarySearch(apicales, car) >= 0)
//            return true;
//        else
//            return false;
//    }
//
//    public static boolean consonneBilabiale(char car) {
//        if (Arrays.binarySearch(bilabiales, car) >= 0)
//            return true;
//        else
//            return false;
//    }
//
//    public static boolean consonneVelaire(char car) {
//        if (Arrays.binarySearch(velaires, car) >= 0)
//            return true;
//        else
//            return false;
//    }
//
//    public static boolean consonneUvulaire(char car) {
//        if (Arrays.binarySearch(uvulaires, car) >= 0)
//            return true;
//        else
//            return false;
//    }
...
//    public static boolean voyellePointee(char car) {
...
//    public static boolean voyelleSimple(char car) {
...
//    public static boolean a(char car) {
//        String c = (String) Syllabics.Short.unicodeXsyl.get(new Character(car));
...
//    public static boolean i(char car) {
//        String c = (String) Syllabics.Short.unicodeXsyl.get(new Character(car));
...
//    public static boolean u(char car) {
//        String c = (String) Syllabics.Short.unicodeXsyl.get(new Character(car));
...
//    // short-vowel
//    // unicode 'v'.
//    public static char simpleApointee(char v) {
...
//     */
//    public static char[] pointeeAdouble(char v) {
...
//    
//    // TYPE DE LETTRE
//    public static function typeLettreLat($lettre) {
//        $consonnes = array( 'g' => 1,, 'h', 'j', 'k', 'l', 'm', 'n', 'p', 'q', 'r',
//                's', 't', 'v', '&', 'N', 'X', 'H' };
//        char voyelles[] = { 'a', 'i', 'u' };
//        Arrays.sort(consonnes);
//        Arrays.sort(voyelles);
//        if (Arrays.binarySearch(consonnes, lettre) >= 0)
//            return C;
//        else if (Arrays.binarySearch(voyelles, lettre) >= 0)
//            return V;
//        else
//            return -1;
//    }
//
//    public static boolean estConsonne(char car) {
//        if (typeLettreLat(car) == C)
//            return true;
//        else
//            return false;
//    }
//
	...
	static private $latinVowels = array('a' => 1, 'i' => 1, 'u' => 1);
	
    public static function isVowel($car) {
 		$logger = Logger::getLogger('Roman.isVowel');  		
 		$logger->debug("\$car= '$car'");
        if ( array_key_exists($car,self::$latinVowels) )
            return true;
        else
            return false;
    }
//
//    public static boolean estCarInuktitut(char c) {
//        return Syllabics.isInuktitutCharacter(c);
//    }
//
//
    public static function latinNasalOfUnvoicedStopConsonant($n) {
        if ($n == 'p')
            return 'm';
        elseif ($n == 't')
            return 'n';
	...
	// Voicing_Action de p, t, k, q
    public static function latinVoicedOfUnvoicedStopConsonant($n) {
        if ($n == 'p')
            return 'v'; // b
        elseif ($n == 't')
            return 'l'; // d
...
//    
//    public static String orthographeDeSon(String son) {
//        if (son.equals("b"))
//            return "p";
//        else if (son.equals("d"))
//            return "t";
//        else
//            return son;
//    }
...
//    static {
//        Arrays.sort(apicales);
//        Arrays.sort(bilabiales);
//        Arrays.sort(velaires);
//        Arrays.sort(uvulaires);
//    }
//
//    /*
