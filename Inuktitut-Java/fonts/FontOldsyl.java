...
// $Id: PoliceOldsyl.java,v 1.1 2009/06/19 19:38:37 farleyb Exp $
//
// Commentaires RCS---------------------------------------RCS Log Messages
//
// $Log: PoliceOldsyl.java,v $
// Revision 1.1  2009/06/19 19:38:37  farleyb
// Nouvelle version de Inuktitut Juin 2009
//
// Revision 1.12  2009/02/10 15:22:30  farleyb
// *** empty log message ***
//
// Revision 1.11  2006/11/01 15:29:56  farleyb
// *** empty log message ***
//
// Revision 1.10  2006/10/20 17:01:26  farleyb
// *** empty log message ***
//
// Revision 1.9  2006/10/19 13:33:18  farleyb
// *** empty log message ***
//
// Revision 1.8  2006/07/20 20:35:41  farleyb
// *** empty log message ***
//
...
public class FontOldsyl {
    ...
    static {
        ...
        for (int i=0; i<unicodesICI2CodesOthers.length; i++) {
            ...
            for (int j=0; j<unicodesICI2CodesOthers[i][1].length(); j++)
                fontChars.add(new Character(unicodesICI2CodesOthers[i][1].charAt(j)));
        }
        wordChars += dotCodes;
