...
// $Id: PoliceAipainunavik.java,v 1.1 2009/06/19 19:38:39 farleyb Exp $
//
// Commentaires RCS---------------------------------------RCS Log Messages
//
// $Log: PoliceAipainunavik.java,v $
// Revision 1.1  2009/06/19 19:38:39  farleyb
// Nouvelle version de Inuktitut Juin 2009
//
// Revision 1.14  2009/02/27 20:06:48  farleyb
// *** empty log message ***
//
// Revision 1.13  2009/02/12 00:18:09  farleyb
// *** empty log message ***
//
// Revision 1.12  2006/11/01 15:29:57  farleyb
// *** empty log message ***
//
// Revision 1.11  2006/10/20 17:01:26  farleyb
// *** empty log message ***
//
// Revision 1.10  2006/10/19 13:33:18  farleyb
// *** empty log message ***
//
...
//                    } else 
            ...
            case '\u00F4':
                boolean precn = false;
                if (sbl != 0 && (sb.charAt(sbl-1)=='\u1595' || sb.charAt(sbl-1)=='\u14d0')) {
                    precn = true;
                    sb.deleteCharAt(sbl-1);
                }
                switch (aipaitai) {
