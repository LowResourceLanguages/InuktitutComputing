...
// -----------------------------------------------------------------------
// Document/File:		PoliceAujaqsyl.java
//
...
// $Id: PoliceAujaqsyl.java,v 1.1 2009/06/19 19:38:36 farleyb Exp $
//
// Commentaires RCS---------------------------------------RCS Log Messages
//
// $Log: PoliceAujaqsyl.java,v $
// Revision 1.1  2009/06/19 19:38:36  farleyb
// Nouvelle version de Inuktitut Juin 2009
//
// Revision 1.5  2009/02/10 15:22:29  farleyb
// *** empty log message ***
//
// Revision 1.4  2006/11/01 15:29:57  farleyb
// *** empty log message ***
//
// Revision 1.3  2006/10/20 17:01:27  farleyb
// *** empty log message ***
//
// Revision 1.2  2006/10/19 13:33:18  farleyb
// *** empty log message ***
//
// Revision 1.1  2006/07/20 20:35:41  farleyb
// *** empty log message ***
//
// Revision 1.4  2006/07/20 18:54:54  farleyb
// *** empty log message ***
//
...
// Initial revision
//
// Revision 1.0  2002-12-03 12:38:47-05  farleyb
// Initial revision
//
//
// -------------------\\Information RCS Information//---------------------
...
public class FontAujaqsyl {
    ...
    static public String transcodeToUnicode(String s, String aipaitaiMode) {
        ...
        while (i < l) {
            ...
            case 'E': // ri
                d = '\u1546'; // ri
                if (dot) {dot=false; sb.deleteCharAt(--sbl); d++;} // rii
            ...
            case 'x': 
                ...
                if (j < l) {
                    ...
                    case 'w': 
                        ...
                        break;
                    default: 
                        if (dot) {sb.deleteCharAt(--sbl);d++;}
                    break;
                    }
                } else if (dot) {sb.deleteCharAt(--sbl);d++;}
                dot=false;
                break;
            case 'X': // pa
                d = '\u1438';
                ...
                if (j < l) {
                    ...
                    case 'w': 
                        switch (aipaitai) {
                        case 1 : d = '\u142F'; break;
                        default: sb.append('\u1438'); d = '\u1403'; i=j; break; // pai
                        }
                        i=j;
                        break;
                    default: 
            ...
            case 'C': // ra
                d = '\u154b';
                if (dot) {dot=false; sb.deleteCharAt(--sbl); d++;} // raa
