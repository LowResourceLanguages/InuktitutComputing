...
public class RomanTest extends TestCase {
	...
	public void testApicalConsonant() {
		if (!Roman.apicalConsonant('n'))
			fail();
	}
	
	public void testTypeLettre() {
	    assertTrue("'a' pas reconnue comme une voyelle.", Roman.typeOfLetterLat('a')==Roman.V);
	    assertTrue("'n' pas reconnue comme une consonne.", Roman.typeOfLetterLat('n')==Roman.C);
	    assertTrue("'N' pas reconnue comme une consonne.", Roman.typeOfLetterLat('N')==Roman.C);
	}
	
	
	public void testLongVowel() {
	    assertTrue("",Roman.longVowel('\u1432'));
	}

	public void testShortVowel() {
	    assertTrue("",Roman.shortVowel('\u1591'));
	}

	public void testA() {
	    assertTrue("",Roman.isSylCharacterA('\u140A'));
	}
	
	public void testSylWithSameVowel() {
	    assertTrue("",Roman.sylWithSameVowel('\u14AA','\u140A'));
	    assertTrue("",!Roman.sylWithSameVowel('\u14AC','\u140A'));
	}
	
	public void testLongToDouble() {
	    char va[] = Roman.longToDouble('\u14AB');
	    assertTrue("",va!=null && va[0]=='\u14AA' && va[1]=='\u140A');
	}
