...
import fonts.FontProsyl;
import junit.framework.TestCase;

public class FontProsylTest extends TestCase {
    ...
    public void testTranscodeToUnicodeStringString() {
        ...
        for (int i=0; i<words.length; i++) {
            ...
            res = FontProsyl.transcodeToUnicode(str,null);
        ...
        for (int i=0; i<wordsAI.length; i++) {
            ...
            res = FontProsyl.transcodeToUnicode(str,"aipaitai");
