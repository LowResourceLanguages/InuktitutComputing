...
import fonts.FontOldsyl;
import junit.framework.TestCase;

public class FontOldsylTest extends TestCase {
    ...
    public void testTranscodeToUnicodeStringString() {
        ...
        for (int i=0; i<words.length; i++) {
            ...
            res = FontOldsyl.transcodeToUnicode(str,null);
        ...
        for (int i=0; i<wordsAI.length; i++) {
            ...
            res = FontOldsyl.transcodeToUnicode(str,"aipaitai");
