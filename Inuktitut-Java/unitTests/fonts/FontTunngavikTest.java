...
import fonts.FontTunngavik;
import junit.framework.TestCase;

public class FontTunngavikTest extends TestCase {
    ...
    public void testTranscodeToUnicodeStringString() {
        ...
        String [][] words = {
                ...
                {"x0p1`Q8q5g~i8ix6gt4","\u140a\u153e\u1528\u1590\u1671\u1466\u1450\u14c3\u14d0\u14c2\u140a\u1585\u1450\u144e\u1483"},
                // ngu: angutiillu
                {"xa`t9l","\u140a\u1591\u144f\u14ea\u14d7"},
                // nguu: arraanguulaaqtumi
                {"x3`C1`A~M6gu","\u140a\u1550\u154c\u1592\u14db\u1585\u1450\u14a5"},
                // nga: gavamangannik
                {"Z?mz8i4","\u1490\u1559\u14aa\u1593\u14d0\u14c2\u1483"},
        ...
        for (int i=0; i<words.length; i++) {
            ...
            res = FontTunngavik.transcodeToUnicode(str,null);
        ...
        for (int i=0; i<wordsAI.length; i++) {
            ...
            res = FontTunngavik.transcodeToUnicode(str,"aipaitai");
