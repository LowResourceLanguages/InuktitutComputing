...
import fonts.FontAipainunavik;
import junit.framework.TestCase;

public class FontAipainunavikTest extends TestCase {
    ...
    public void testTranscodeToUnicodeStringString() {
        ...
        for (int i=0; i<words.length; i++) {
            ...
            res = FontAipainunavik.transcodeToUnicode(str,null);
        ...
        for (int i=0; i<wordsAI.length; i++) {
            ...
            res = FontAipainunavik.transcodeToUnicode(str,"aipaitai");
