...
import fonts.FontAipainuna;
import junit.framework.TestCase;

public class FontAipainunaTest extends TestCase {
    ...
    public void testTranscodeToUnicodeStringString() {
        ...
        String [][] words = {
                ...
                {"WNhxMs3ym‡g6","\u1431\u14c7\u14f1\u140a\u14da\u1405\u1550\u14ef\u14aa\u1671\u1450\u1585"},
                // nngii: atanngiijjutauniaqpuq
                {"xb\u22190Jbsix6S6","\u140a\u1455\u1672\u153e\u152a\u1455\u1405\u14c2\u140a\u1585\u1433\u1585"},
                // nngu: nunannguatigut
                {"kN\u201axtA5","\u14c4\u14c7\u1673\u140a\u144e\u148d\u1466"},
        ...
        for (int i=0; i<words.length; i++) {
            ...
            res = FontAipainuna.transcodeToUnicode(str,null);
            assertEquals("1. word#"+i+" : "+res+" au lieu de "+targ,targ,res);
        }
        ...
        for (int i=0; i<wordsAI.length; i++) {
            ...
            res = FontAipainuna.transcodeToUnicode(str,"aipaitai");
