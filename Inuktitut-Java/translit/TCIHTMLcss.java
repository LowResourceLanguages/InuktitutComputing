...
public class TCIHTMLcss {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            translittererPage(args[1], args[2], aipaitai, new PrintStream(System.out, true, "utf-8"));
        } catch (Exception e) {
        }
    }
    ...
    private static String usage(String com) {
    	return "Usage: "+com+" <url> <conversion> <aipaitai>\n\t"
